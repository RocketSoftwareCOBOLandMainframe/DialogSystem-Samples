       ...
       01 OK type System.Windows.Forms.Button.
       01 dataGridViewTextBoxColumn1 type System.Windows.Forms.DataGridViewTextBoxColumn.
       01 calendarColumn1 type OrderFormsLibrary.CalendarColumn.
       ...
       01 OrderDate type OrderFormsLibrary.CalendarColumn.
      ...
      *> the contents of this method with the code editor.
       ...
       set OrderDate to new OrderFormsLibrary.CalendarColumn
       ...
       set OK to new System.Windows.Forms.Button
       set self::DeleteBtn to new System.Windows.Forms.Button
       set dataGridViewTextBoxColumn1 to new System.Windows.Forms.DataGridViewTextBoxColumn
       set calendarColumn1 to new OrderFormsLibrary.CalendarColumn
      ...
      *> 
       ...
       set OrdersGridView::Location to new System.Drawing.Point( 28 38)
       set OrdersGridView::Name to "OrdersGridView"
       set OrdersGridView::Size to new System.Drawing.Size( 558 157)
       set OrdersGridView::TabIndex to 0
      *> 
      *> OrderNo
      *> 
      ...
      *> OK
      *> 
       set OK::Anchor to type System.Windows.Forms.AnchorStyles::Bottom b-or type System.Windows.Forms.AnchorStyles::Left as type System.Windows.Forms.AnchorStyles
       set OK::Location to new System.Drawing.Point( 28 218)
       set OK::Name to "OK"
       set OK::Size to new System.Drawing.Size( 75 30)
       set OK::TabIndex to 1
       set OK::Text to "OK"
       set OK::UseVisualStyleBackColor to True
       invoke OK::add_Click(new System.EventHandler(self::OK_Click))
      *> 
      *> Delete
      *> 
       set self::DeleteBtn::Anchor to type System.Windows.Forms.AnchorStyles::Bottom b-or type System.Windows.Forms.AnchorStyles::Left as type System.Windows.Forms.AnchorStyles
       set self::DeleteBtn::Location to new System.Drawing.Point( 109 218)
       set self::DeleteBtn::Name to "Delete"
       set self::DeleteBtn::Size to new System.Drawing.Size( 75 30)
       set self::DeleteBtn::TabIndex to 1
       set self::DeleteBtn::Text to "Delete"
       set self::DeleteBtn::UseVisualStyleBackColor to True
       invoke self::DeleteBtn::add_Click(new System.EventHandler(self::Delete_Click))
      *> 
      ...
      *> 
       set dataGridViewCellStyle6::NullValue to "0"
      ...
      *> 
       ...
       set dataGridViewCellStyle7::Format to "0.00"
      ...
      *> 
       set dataGridViewCellStyle8::Format to "0.00"
      ...
      *> OrderForm
      *> 
       set self::ClientSize to new System.Drawing.Size( 621 270)
       invoke self::Controls::Add(self::DeleteBtn)
       invoke self::Controls::Add(OK)
       invoke self::Controls::Add(OrdersGridView)
       set self::MaximizeBox to False
       set self::MinimizeBox to False
       set self::Name to "OrderForm"
       set self::ShowInTaskbar to False
       set self::Text to "Order Entry"
       invoke self::add_FormClosing(new System.Windows.Forms.FormClosingEventHandler(self::OrderForm_FormClosing))
       invoke self::add_Load(new System.EventHandler(self::OrderForm_Load))
